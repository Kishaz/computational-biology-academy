...
<div class="cba-comic">
```
![](img/comic-r.svg){fig-alt="Three-panel comic: Pendo asks what R even is, Amina explains it is a language you speak to your data, and that you ask a question and it answers the same way every time."}
```{=html}
</div>
```
